...
fun shouldFlyBoost(): Boolean {
    return gameSettings.keyBindSprint.isKeyDown && PolySprintConfig.enabled && PolySprintConfig.toggleFlyBoost && player!!.capabilities.isFlying && !HypixelUtils.INSTANCE.isHypixel
}
